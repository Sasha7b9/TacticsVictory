...
#include "Game/Objects/Terrain/lTerrainSegment.h"
...
Plane lTerrain::GetPlane(uint row, uint col)
{
...
Plane lTerrain::GetIntersectionPlane(Ray &ray)
{
...
Line lTerrain::GetIntersectionEdge(Ray &ray)
{
