...
const UIntVector2 SET::WINDOW::SIZE = {SET::WINDOW::WIDTH, SET::WINDOW::HEIGHT};
const UIntVector2 SET::PANEL::BOTTOM::SIZE = {SET::PANEL::BOTTOM::WIDTH, SET::PANEL::BOTTOM::HEIGHT};
const UIntVector2 SET::PANEL::MAP::SIZE = {SET::PANEL::MAP::WIDTH, SET::PANEL::MAP::HEIGHT};
const UIntVector2 SET::PANEL::MAIN::SIZE = {SET::PANEL::MAIN::WIDTH, SET::PANEL::MAIN::HEIGHT};
const UIntVector2 SET::MENU::SLIDER::SIZE = {SET::MENU::SLIDER::WIDTH, SET::MENU::SLIDER::HEIGHT};
const UIntVector2 SET::MENU::DDLIST::SIZE = {SET::MENU::DDLIST::WIDTH, SET::MENU::DDLIST::HEIGHT};
const UIntVector2 SET::MENU::TEXT::SIZE = {SET::MENU::TEXT::WIDTH, SET::MENU::TEXT::HEIGHT};
const UIntVector2 SET::MENU::GOVERNOR::CELL::SIZE = {SET::MENU::GOVERNOR::CELL::WIDTH, SET::MENU::GOVERNOR::CELL::HEIGHT};
