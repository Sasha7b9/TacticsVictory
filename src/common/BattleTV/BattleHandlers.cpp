...
void Battle::HandlePostRenderUpdate(StringHash, VariantMap&)
{
    if(drawDebug)
    {
...
void Battle::HandleKeyDown(StringHash, VariantMap& eventData) //-V2009
{
...
void Battle::HandleMenuEvent(StringHash, VariantMap& eventData) //-V2009
{
